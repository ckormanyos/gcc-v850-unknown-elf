...
#
# Example call:
#   ./v850-unknown-elf-gcc-100-my_ver_x86_64-w64-mingw32.sh 13.2.0 /c/mingw
#
...
#cp ../v850-unknown-elf-gcc-100-"$MY_VERSION"_x86_64-w64-mingw32.patch .
#echo
...
ls -la $SCRIPT_DIR/local/gcc-"$MY_VERSION"-v850-unknown-elf/bin/v850-unknown-elf-ld.exe
result_binutils=$?
...
#   diff -ru gcc-12.3.0/ gcc-12.3.0_new/ > v850-unknown-elf-gcc-100-12.3.0_x86_64-w64-mingw32.patch

# How do you apply the patch? (Example for gcc-12.3.0)
#   patch -p0 < v850-unknown-elf-gcc-100-12.3.0_x86_64-w64-mingw32.patch
...
ls -la $SCRIPT_DIR/local/gcc-"$MY_VERSION"-v850-unknown-elf/bin
ls -la $SCRIPT_DIR/local/gcc-"$MY_VERSION"-v850-unknown-elf/bin/v850-unknown-elf-g++.exe
result_gcc=$?
